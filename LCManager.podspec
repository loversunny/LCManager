#
#  Be sure to run `pod spec lint LCManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/loversunny/LCManager.git", :tag => "#{s.version}" }
